...
class RegisterCoursesTest(unittest.TestCase):
    ...
    @data(("Learn Python 3 from scratch",), ("JavaScript for beginners",))
    @unpack
    def test_invalidCourseRegister(self, course_title,):
        self.rp.enroll_course(course_title=course_title)
